...
def form():
    ...
    if i.b_verified:
        ...
        # Initialize the radio buttons from the boolean data base field
        form.vars['mail_enabled'] = 'yes' if i.person['mail_enabled'] else 'no'
        # Note: The SQLFORM constructor augments the list of fields with 'id'!
        del form.vars['id']
        # Initialize data use agreement with 'No!'
        form.vars['data_use_agreed'] = ''
