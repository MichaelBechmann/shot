...
function (_Plugin) {
  ...
  _createClass(Sticky, [{
    ...
    value: function _setSizes(cb) {
      ...
      this.$element.css({
        //'max-width': `${newElemWidth - pdngl - pdngr}px` //Bec fix, original line
        'max-width': '100%' //Bec fix, fixed line
...
Triggers.init = function ($, Foundation) {
  Object(_foundation_core_utils__WEBPACK_IMPORTED_MODULE_1__["onLoad"])($(window), function () {
    if ($.triggersInitialized !== true) {
      Triggers.Initializers.addSimpleListeners(); // mytest src

      Triggers.Initializers.addGlobalListeners(); // mytest src
...
/* harmony import */ var _node_modules_foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/foundation-sites/js/foundation.util.triggers */ "./node_modules/foundation-sites/js/foundation.util.triggers.js");
/* harmony import */ var foundation_sites_js_foundation_sticky__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! foundation-sites/js/foundation.sticky */ "./node_modules/foundation-sites/js/foundation.sticky.js");
...
_node_modules_foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_2__["Triggers"].Initializers.addSimpleListeners();
_node_modules_foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_2__["Triggers"].Initializers.addGlobalListeners();
jquery__WEBPACK_IMPORTED_MODULE_0___default.a.triggersInitialized = true; //Foundation.IHearYou = Triggers.Initializers.addGlobalListeners
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  var classname = 'quick-menu-items-' + jquery__WEBPACK_IMPORTED_MODULE_0___default()('#quick-menu .button').length.toString();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#content-wrapper, .top-bar').addClass(classname); // Add and remove a class to the off-canvas elements (side menu)
  // if the size of the title bar changes.
  // With the class the off-canvas elements can be shifted up and down accordingly.

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.top-bar').on('sticky.zf.stuckto:top', function () {
    var h_window = window.innerHeight;
    var h_content = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.off-canvas-content').height();
    ...
    if (h_content > 1.2 * h_window) {
       ...
       */
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.top-bar').addClass('can-minify');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.off-canvas').addClass('title-bar-slim');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.title-bar-big').removeClass('title-bar-big');
    }
  }).on('sticky.zf.unstuckfrom:top', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.off-canvas').addClass('title-bar-big');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.top-bar').removeClass('can-minify');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.title-bar-slim').removeClass('title-bar-slim');
  });
  /**
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#quick-menu a.button:not(.active)').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.active').removeClass('active');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu li:not(.is-accordion-submenu-parent).active > a').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu').foundation('close');
  });
  /**
   * Toggle activity class when sub menu item is clicked.
   */

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu .is-accordion-submenu-parent > a').click(function () {
...
module.exports = __webpack_require__(/*! /home/bechmann/projects/web/web2py/applications/shot/foundation_shot/src/assets/js/app.js */"./src/assets/js/app.js");
