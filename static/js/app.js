...
/* harmony import */ var _fixes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./fixes.js */ "./src/assets/js/fixes.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#content-wrapper').addClass(classname); // Invoke the function foundation() when the document is ready, i.e. the DOM is complete. Any sub-sources (e.g., images)
  // need not to be loaded yet.

  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // Add and remove a class to the off-canvas elements (menu, schedule)
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.top-bar').on('sticky.zf.stuckto:top', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.off-canvas, #top-bar-wrapper').addClass('title-bar-slim');
  }).on('sticky.zf.unstuckfrom:top', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.title-bar-slim').removeClass('title-bar-slim');
  }); // execute fixes

  Object(_fixes_js__WEBPACK_IMPORTED_MODULE_3__["framework_fixes"])();
});

/***/ }),

/***/ "./src/assets/js/fixes.js":
/*!********************************!*\
  !*** ./src/assets/js/fixes.js ***!
  \********************************/
/*! exports provided: framework_fixes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "framework_fixes", function() { return framework_fixes; });
/* harmony import */ var _node_modules_foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../node_modules/foundation-sites/js/foundation.util.triggers */ "./node_modules/foundation-sites/js/foundation.util.triggers.js");
/**
...
function framework_fixes() {
   ...
   */
  _node_modules_foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_0__["Triggers"].Initializers.addSimpleListeners();
  _node_modules_foundation_sites_js_foundation_util_triggers__WEBPACK_IMPORTED_MODULE_0__["Triggers"].Initializers.addGlobalListeners();
  /**
